...
if ($recommencer != 'non' AND is_numeric($recommencer)) {
    ...
    //!!! pour ne pas recommencer a une étape ultérieure à l'étape actuelle
    $modifier = mysqli_query($GLOBALS["mysqli"], "UPDATE edt_init SET nom_export = " . $recommencer . " WHERE ident_export = 'fichierTexte2' AND  nom_export > ".$recommencer." ")
